        ...
        <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>WEB SPIDER BD. <br />Providing reliable tech since 2020. <br /> Developed By:
                        <ExternalButton href="https://www.facebook.com/reshad.rashed.7" target='_blank'>Rashed Uzzaman Reshad</ExternalButton>
                    </p>
                </div>
